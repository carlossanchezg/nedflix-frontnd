...
const WatchTrailer = () => {
    ...
    return ( 
        <div className="body " >
            <div class="embed-responsive embed-responsive-16by9 mb-5">
                <iframe class="embed-responsive-item" src={`https://www.youtube.com/embed/${movieId.video_trailer}`} allowfullscreen></iframe>
            </div>
            <Footer />
        </div> 
     );
  ...
  return (
    <React.Fragment>
      { isAuth ? AuthWatchTrailer() : <Redirect to="/" /> }
    </React.Fragment>
  )
}
